...
Per condition: accuracy (the RQ1 primary outcome, as the mean of per-participant proportions), the
pre-registered T5 adjacent-band secondary, Paas mental effort (RQ3), and time on task. Plus the
